...
@NoArgsConstructor
@AllArgsConstructor
public class EvaProProductEntity {
    ...
    @Excel(name = "商品图片", type = 2, width = 20,height = 30)
    ...
    @Excel(name = "返现活动总次数")
    private Integer trialsTotalTimes;

    @Excel(name = "返现活动已有次数")
    private Integer trialsTimes;

    @Excel(name = "商品是否上架")
    private String isShelve;

    @Excel(name = "商品预览图")
    private String productPicImageUrl;
