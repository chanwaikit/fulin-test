...
public class CreateOrder  {
	 ...
	 */
	public HttpResponse<Order> createOrder(boolean debug, PayPalEnvironment environment) throws IOException, JSONException {
	...
	public static void main(String args[]) {
		try {
			...
			new CreateOrder().createOrder(true,environment);
